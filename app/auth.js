//we're using (name,pass) here , for other Provider check docs , https://next-auth.js.org/providers/credentials
...
//NextAuth function to get {signIn, signOut, auth} functions .. using (authConfig , login) functions , it'll be used at the controller 
