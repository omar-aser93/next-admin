import { updateProduct } from "@/app/lib/actionControllers";
import { fetchProduct } from "@/app/lib/getControllers";
import styles from "./singleProduct.module.css";
import Image from "next/image";

const SingleProduct = async ({ params }) => {     //receive url params as props from products table page

  const { id } = params;                      //get the id from the url params (the page name is [id])
  const product = await fetchProduct(id);     //Api fetch req , pass the id then get the product data
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.formContainer}>
        ...
        {/* updateProduct Api req using server actions */}
