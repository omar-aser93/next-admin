import { deleteUser } from "@/app/lib/actionControllers";
import { fetchUsers } from "@/app/lib/getControllers";
...
const Users = async ({ searchParams }) => {         //searchParams is input queries from search & pagination components
  ...
  const { count, users } = await fetchUsers(q, page);       //Api fetch req , pass the queries then get all users & count
            ...
            <tr key={user.id}>
              ...
              <td>
                <div className={styles.buttons}>
                  ...
                  <form action={deleteUser}>         {/* deleteUser Api req using server actions */}
