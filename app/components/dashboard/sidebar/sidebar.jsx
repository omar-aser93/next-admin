...
import { logout } from '@/app/lib/actionControllers';
...
const Sidebar = async () => {
  ...
  const { user } = await auth();             //get the user data of the session from using NextAuth  (auth.js file)
  ...
  return (
    <div className={styles.container}>
     ...
     <form action={logout}>                  {/* logout Api req using server actions */}
